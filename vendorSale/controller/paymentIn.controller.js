...
exports.createReceivedPayment = async (req, res, next) => {
    const mainUser = req.user;
    try {
        const {
            clientId,
        ...
        const newPaymentOut = await paymentInService.createReceivedPayment(clientId, dataObject, mainUser);
        return res.status(statusCode.OK).send({
...
exports.createReceivedPaymentDn = async (req, res, next) => {
    const mainUser = req.user;
    try {
        const {
            clientId,
        ...
        const newPaymentOut = await paymentInService.createReceivedPaymentDn(clientId, dataObject, mainUser);
        return res.status(statusCode.OK).send({
            message: "Payment received created successfully.",
            data: { holidayId: newPaymentOut._id },
        });
