...
const performaService = require("../service/performa.service");
...
exports.create = async (req, res, next) => {
    try {
        ...
        const newPurchaseOrder = await performaService.create(clientId, dataObject);
...
exports.update = async (req, res, next) => {
    ...
    try {
        ...
        // update  
        const updated = await performaService.update(clientId, holidayId, dataObject);
        return res.status(statusCode.OK).send({
...
exports.list = async (req, res, next) => {
    try {
        ...
        let filters = {
            ...
            ...(keyword && {
                $or: [
                    { spNumber: { $regex: keyword.trim(), $options: "i" } },
                ],
            }),
        };
        if (level == "vendor") {
        ...
        const result = await performaService.list(clientId, filters, { page, limit: perPage });
        return res.status(statusCode.OK).send({
...
exports.changeStatus = async (req, res, next) => {
    try {
        ...
        const updated = await performaService.changeStatus(clientId, id, dataObject);
