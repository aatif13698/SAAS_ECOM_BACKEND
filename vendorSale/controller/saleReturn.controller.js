...
const saleReturnService = require("../service/saleReturn.service");
...
exports.update = async (req, res, next) => {
    ...
    try {
        ...
        // update  
        const updated = await saleReturnService.update(clientId, holidayId, dataObject);
        return res.status(statusCode.OK).send({
...
exports.issueMail = async (req, res, next) => {
    try {
        ...
        const purchaseOrder = await saleReturnService.getById(clientId, purchaseOrderId);
...
exports.getParticular = async (req, res, next) => {
    try {
        ...
        const sr = await saleReturnService.getById(clientId, saleReturnId);
        return res.status(200).send({
...
exports.list = async (req, res, next) => {
    try {
        ...
        let filters = {
            ...
            ...(keyword && {
                $or: [
                    { srNumber: { $regex: keyword.trim(), $options: "i" } },
                ],
            }),
        };
        if (level == "vendor") {
        ...
        const result = await saleReturnService.list(clientId, filters, { page, limit: perPage });
        return res.status(statusCode.OK).send({
...
exports.changeStatus = async (req, res, next) => {
    try {
        ...
        const updated = await saleReturnService.changeStatus(clientId, id, {
            status: status,
        });
