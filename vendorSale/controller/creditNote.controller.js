...
const creditNoteService = require("../service/creditNote.service");
...
exports.create = async (req, res, next) => {
    try {
        ...
        const newData = await creditNoteService.create(clientId, dataObject, mainUser);
...
exports.applyCrditToInvoice = async (req, res, next) => {
    ...
    try {
        ...
        const newPaymentOut = await creditNoteService.applyCreditToInvoice(clientId, dataObject, mainUser);
        return res.status(statusCode.OK).send({
...
exports.update = async (req, res, next) => {
    ...
    try {
        ...
        // update  
        const updated = await creditNoteService.update(clientId, holidayId, dataObject);
        return res.status(statusCode.OK).send({
...
exports.issueMail = async (req, res, next) => {
    try {
        ...
        const purchaseOrder = await creditNoteService.getById(clientId, purchaseOrderId);
...
exports.list = async (req, res, next) => {
    try {
        ...
        let filters = {
            ...
            ...(keyword && {
                $or: [
                    { cnNumber: { $regex: keyword.trim(), $options: "i" } },
                ],
            }),
        };
        if (level == "vendor") {
        ...
        const result = await creditNoteService.list(clientId, filters, { page, limit: perPage });
        return res.status(statusCode.OK).send({
...
exports.changeStatus = async (req, res, next) => {
    try {
        ...
        const updated = await creditNoteService.changeStatus(clientId, id, {
            status: status,
        });
