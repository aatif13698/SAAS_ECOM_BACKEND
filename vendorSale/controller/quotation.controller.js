...
exports.create = async (req, res, next) => {
    try {
        ...
        const newPurchaseOrder = await quotationService.create(clientId, dataObject);
...
exports.update = async (req, res, next) => {
    ...
    try {
        ...
        // update  
        const updated = await quotationService.update(clientId, holidayId, dataObject);
        return res.status(statusCode.OK).send({
...
exports.list = async (req, res, next) => {
    try {
        ...
        let filters = {
            ...
            ...(keyword && {
                $or: [
                    { sqNumber: { $regex: keyword.trim(), $options: "i" } },
                ],
            }),
        };
        if (level == "vendor") {
        ...
        const result = await quotationService.list(clientId, filters, { page, limit: perPage });
        return res.status(statusCode.OK).send({
            message: message.lblHolidayFoundSucessfully,
            data: result,
        });
