...
exports.list = async (req, res, next) => {
    try {
        ...
        const result = await currencyService.list(clientId, filters, { page, limit: perPage });
        return res.status(statusCode.OK).send({
...
exports.all = async (req, res, next) => {
    try {
        ...
        const result = await currencyService.all(clientId, filters,);
        return res.status(statusCode.OK).send({
...
exports.allField = async (req, res, next) => {
    try {
        ...
        const result = await currencyService.allField(clientId, groupId);
        return res.status(statusCode.OK).send({
...
exports.getParticular = async (req, res, next) => {
    try {
        ...
        const shift = await currencyService.getById(clientId, shiftId);
