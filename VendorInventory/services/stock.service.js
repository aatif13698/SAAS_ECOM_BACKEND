...
const getListStockOfSupplierByPurchaseInv = async (
    clientId,
    keyword = '',
    categoryId = null,
    subCategoryId = null,
    ...
    try {
        ...
        const inv = await PurchaseInvoice.findById(purchaseInvId);

        const items = inv.items.map((itm) => {
            return itm.itemName
        });
        ...
        const productStockIds = items.map(item => item.productStock);
        const productMainStockIds = items.map(item => item.productMainStock);
...
const getListStockOfCustomerBySaleInv = async (
    clientId,
    keyword = '',
    categoryId = null,
    subCategoryId = null,
    ...
    try {
        ...
        const inv = await SaleInvoice.findById(saleInvId);
...
module.exports = {
    ...
    getListStockOfSupplierByPurchaseInv,
    getListStockOfCustomerBySaleInv,
