...
// list stock of supplier
exports.listStockOfSupplier = async (req, res, next) => {
    try {
        const mainUser = req.user;
        const {
            clientId,
        ...
        const result = await stockService.getListStockOfSupplier(
            clientId,
            keyword,
            categoryId,
            subCategoryId,
...
exports.listStockOfSupplierByPurchInv = async (req, res, next) => {
    try {
        const mainUser = req.user;
        const {
            clientId,
        ...
        if (!clientId) {
         ...
         if (!purchaseInvId) {
            return res.status(400).send({
                message: "Purchase inv ID is required",
            });
        }
        ...
        const result = await stockService.getListStockOfSupplierByPurchaseInv(
            clientId,
            keyword,
            categoryId,
            subCategoryId,
...
exports.listStockForCustomer = async (req, res, next) => {
    try {
        ...
        const result = await stockService.getListStockForCustomer(
            clientId,
            keyword,
            categoryId,
            subCategoryId,
...
exports.listBlueprintForCms = async (req, res, next) => {
    try {
        const mainUser = req.user;
        const {
            clientId,
        ...
        const result = await stockService.getListBlueprintsForCms(
            clientId,
            keyword,
            categoryId,
            subCategoryId,
