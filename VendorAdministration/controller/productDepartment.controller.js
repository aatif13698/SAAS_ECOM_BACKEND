...
const productDepartmentService = require("../services/productDepartment.service");  
...
exports.create = async (req, res, next) => {  
    try {  
        ...
        const newWorkingDepartment = await productDepartmentService.create(clientId, dataObject);  
...
exports.update = async (req, res, next) => {  
    ...
    try {  
        ...
        // update   
        const updated = await productDepartmentService.update(clientId, workingDepartmentId, dataObject);  
...
exports.getParticular = async (req, res, next) => {  
    try {  
        ...
        const shift = await productDepartmentService.getById(clientId, shiftId);  
...
exports.list = async (req, res, next) => {  
    try {  
        ...
        const result = await productDepartmentService.list(clientId, filters, { page, limit: perPage });  
        return res.status(statusCode.OK).send({  
            message: message.lblShiftFoundSucessfully,  
            data: result,  
        });  
...
exports.activeinactive = async (req, res, next) => {  
    try {  
        ...
        const updated = await productDepartmentService.activeInactive(clientId, id, {  
            isActive: status == "1",  
        });  
