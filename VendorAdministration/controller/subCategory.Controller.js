...
exports.getAllActiveCategory = async (req, res, next) => {
    try {
        ...
        const category = await subCategoryService.allActiveCategory(clientId);
...
exports.createSubCategory = async (req, res, next) => {
    try {
        const { clientId, categoryId, name, description, slug } = req.body;
...
exports.updateSubCategory = async (req, res, next) => {
    try {
        const { clientId, categoryId, subCategoryId, name, description, slug } = req.body;
...
exports.getParticularSubCategory = async (req, res, next) => {
    try {
...
exports.getSubcategoryByCategory = async (req, res, next) => {
    try {
        ...
        const subCategory = await subCategoryService.subcategoryByCategory(clientId, categoryId);
        return res.status(200).send({
            message: message.lblSubCategoryFoundSuccessfully,
            data: subCategory,
        });
...
exports.listSubCategory = async (req, res, next) => {
    try {
        ...
        const result = await subCategoryService.list(clientId, filters, { page, limit: perPage });
        return res.status(statusCode.OK).send({
            message: message.lblSubCategoryFoundSuccessfully,
            data: result,
        });
...
exports.softDeleteSubCategory = async (req, res, next) => {
    try {
        const { clientId, keyword, page, perPage, subCategoryId } = req.body;
        req.query.clientId = clientId;
        req.query.keyword = keyword;
        req.query.page = page;
        req.query.perPage = perPage;
        ...
        await subCategoryService.deleted(clientId, subCategoryId, softDelete = true)
        this.listSubCategory(req, res, next);
    } catch (error) {
        next(error);
    }
