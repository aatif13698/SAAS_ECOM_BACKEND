...
const changeShiftService = require("../services/changeShift.service");
...
exports.create = async (req, res, next) => {
    try {
        ...
        const newChangeShift = await changeShiftService.create(clientId, dataObject);
        return res.status(statusCode.OK).send({
            message: "Shift change request submitted successfully.",
            data: { shiftId: newChangeShift._id },
        });
    } catch (error) {
        next(error);
    }
...
exports.update = async (req, res, next) => {
    ...
    try {
        ...
        // update  
        const updated = await changeShiftService.update(clientId, shiftId, dataObject);
...
exports.allShift = async (req, res, next) => {
    try {
        ...
        const result = await changeShiftService.all(clientId, filters);
        return res.status(statusCode.OK).send({
...
exports.activeinactive = async (req, res, next) => {
    try {
        ...
        const updated = await changeShiftService.activeInactive(clientId, id, {
            isActive: status == "1",
        });
...
exports.getParticular = async (req, res, next) => {
    try {
        ...
        const shift = await changeShiftService.getById(clientId, shiftId);
