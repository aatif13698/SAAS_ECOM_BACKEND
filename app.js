...
const leaveAllotmentRoute = require("./VendorHr/routes/leaveAllotment.routes.js");
...
const DabitNote = require("./vendorPurchase/routes/debitNote.routes.js");
...
const CreditNote = require("./vendorSale/routes/creditNote.routes.js");
...
app.use("/api/vendor/hr/leave/allotment", leaveAllotmentRoute.router);
...
app.use("/api/vendor/purhcase/dn", DabitNote.router);
...
app.use("/api/vendor/sale/cn", CreditNote.router);
