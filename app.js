...
app.use(cors({
  origin: ['http://127.0.0.1:5173', 'http://127.0.0.1:5174', 'http://localhost:5173', 'http://localhost:5174', 'https://dolphin-app-2-kv7tw.ondigitalocean.app'], // Allow Vite dev server
