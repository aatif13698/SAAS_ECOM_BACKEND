...
purchaseReturnSchema.index({ businessUnit: 1, poDate: -1 });
purchaseReturnSchema.index({ branch: 1, poDate: -1 });
purchaseReturnSchema.index({ supplier: 1, poDate: -1 });

// Virtual for total order amount (computed)
purchaseReturnSchema.virtual('totalOrderAmount').get(function () {
