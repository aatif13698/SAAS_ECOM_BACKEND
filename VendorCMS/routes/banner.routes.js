...
router.post('/update/banner', entityAuth.authorizeEntity("Accounting Master", "Financial Year", "update"), bannerController.update);
...
router.get('/get/banner/by/id/:clientId/:id', entityAuth.authorizeEntity("Accounting Master", "Financial Year", "create"), bannerController.sectionById);
