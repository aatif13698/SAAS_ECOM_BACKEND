...
exports.createForSaleReturn = async (req, res, next) => {
    const mainUser = req.user;
    try {
        const {
            clientId,
        ...
        const newPaymentOut = await paymentOutService.createForSaleReturn(clientId, dataObject, mainUser);
        return res.status(statusCode.OK).send({
            message: "Payment out created successfully.",
            data: { holidayId: newPaymentOut._id },
        });
...
exports.createForCreditNote = async (req, res, next) => {
    const mainUser = req.user;
    try {
        const {
            clientId,
        ...
        const newPaymentOut = await paymentOutService.createForCreditNote(clientId, dataObject, mainUser);
        return res.status(statusCode.OK).send({
            message: "Payment out created successfully.",
            data: { holidayId: newPaymentOut._id },
        });
