...
exports.create = async (req, res, next) => {
    try {
        ...
        const newInvoice = await purchaseReturnService.create(clientId, dataObject, mainUser);

        // === QUEUE THE AUDIT JOB (non-blocking) ===
        const agenda = await getAgenda();
        await agenda.now('audit-purchase-return', {
            clientId,
...
exports.update = async (req, res, next) => {
    ...
    try {
        ...
        // update  
        const updated = await purchaseReturnService.update(clientId, holidayId, dataObject);
        return res.status(statusCode.OK).send({
...
exports.issueMail = async (req, res, next) => {
    try {
        ...
        const purchaseOrder = await purchaseReturnService.getById(clientId, purchaseOrderId);
...
exports.changeStatus = async (req, res, next) => {
    try {
        ...
        const updated = await purchaseReturnService.changeStatus(clientId, id, {
            status: status,
        });
